            ...
            function(module, exports, __webpack_require__) {
                ...
                var Column = (function() {
                    function Column(dataKey, index, isImage) { //isImage added by john.chen
                        ...
                        this.index = index;
                        this.isImage = isImage ? true : false; //add by john.chen
                    }
                    return Column;
                }());
                        ...
                        table.rows.concat(table.headerRow).forEach(function(row) {
                            ...
                            if (column.isImage) {
                                ...
                                if (typeof text == 'string' && text.startsWith('data:image/'))
                                    width = imageWidth; //如果是图片,宽度固定为默认值
                            }
                    ...
                    all.forEach(function(row) {
                        table.columns.forEach(function(col) {
                            ...
                            if (col.isImage) {
                                var text = Array.isArray(cell.text) && cell.text.length ? cell.text[0] : cell.text;
                                if (typeof text == 'string' && text.startsWith('data:image/'))
                                    height = imageHeight; //如果是图片,宽度固定为默认值
                            }
            ...
            function(module, exports, __webpack_require__) {
                ...
                function createModels(inputHeaders, inputData) {
                    ...
                    inputHeaders.forEach(function(rawColumn, index) {
                        ...
                        var col = new models_1.Column(dataKey, index, rawColumn.isImage);
